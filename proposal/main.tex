...
\subheading{Purpose}
The purpose of the project is to experiment with how a simple baseline model for object detection can be improved through a series of experiments. 

The goal is not to effectively solve the problem of object detection but rather gain insight and understanding of why different changes have the outcome they have. We believe this is easier done if the experiments are carried out on a simple model which we can ourselves grasp and gradually increase the complexity of; opposed to a complex pre-trained model. 
